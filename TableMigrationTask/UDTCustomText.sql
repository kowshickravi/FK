CREATE TABLE IF NOT EXISTS dbo."UDTCustomText"
(
  "UDTId"                   INTEGER  GENERATED ALWAYS AS IDENTITY     NOT NULL,
  "SerID"                   INTEGER                                   NOT NULL,
  "ConID"                   INTEGER                                   NULL,
  "levelIncreases?"         BOOLEAN                                   NOT NULL,
  "UseDefault"              BOOLEAN                                   NOT NULL,
  "Periodoftime"            SMALLINT                                  NOT NULL,
  "DateCreated"             TIMESTAMP(3)                              NOT NULL CONSTRAINT "DF_UDTCustomText"                       DEFAULT LOCALTIMESTAMP,
  ...
  "IsGroup"                 BOOLEAN                                   NOT NULL CONSTRAINT "DF_tlsenforcedroutes_IsGroup"           DEFAULT FALSE,         
      CONSTRAINT "PK_UDTCustom" PRIMARY KEY
  (
  "UDTId"
  )
);

CREATE UNIQUE INDEX IF NOT EXISTS "IN_UDTId"
ON dbo."UDTCustomText"
(
   "ConID",
