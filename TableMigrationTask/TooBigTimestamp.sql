...
(
  ...
  "Thingid"                 INTEGER                                   NULL,
  "levelIncreases?"         BOOLEAN                                   NOT NULL,
  "UseDefault"              BOOLEAN                                   NOT NULL,
  "Periodoftime"            SMALLINT                                  NOT NULL,
  "DateCreated"             TIMESTAMP(3)                              NOT NULL  CONSTRAINT "DF_TooBigTimestamp"                      DEFAULT LOCALTIMESTAMP,
  ...
  "IsGroup"                 BOOLEAN                                   NOT NULL  CONSTRAINT "DF_tlsenforcedroutes_IsGroup"            DEFAULT FALSE,         
      CONSTRAINT "PK_TooBigTimestamp" PRIMARY KEY
  (
  "Tempid"
  )
);

CREATE UNIQUE INDEX IF NOT EXISTS "IN_Tempid"
ON dbo."TooBigTimestamp"
(
   "Modelid",
   "Thingid" ASC NULLS FIRST
);