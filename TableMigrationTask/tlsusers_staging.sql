...
(
  ...
  "DateCreated"             TIMESTAMP(3)                              NOT NULL  CONSTRAINT "DF_tlsusers_staging"                     DEFAULT LOCALTIMESTAMP,
...
CREATE UNIQUE INDEX IF NOT EXISTS "IN_StageID"
ON dbo."tlsusers_staging"
(
   "Userid",
   "StageID" ASC NULLS FIRST
);