...
(
  "EnforceID"                           INTEGER  GENERATED ALWAYS AS IDENTITY    NOT NULL,
  "EnGroupID"                           INTEGER                                  NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "IN_EnforceID"
ON dbo."TLSEnforcementDomainGroup"
(
   "EnforceID",
